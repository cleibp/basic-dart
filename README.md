<h1 align="center"> 🚀 Dart Básico </h1>

## ✍️ Descrição
Exemplificação da sintaxe geral e básica da Linguagem Dart
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/basic-dart.git
    ```
1. Download:
    ### Download Manual
...
## 👋🏽 DEMO
[REPLIT](https://replit.com/@cleibp/Basic-Dart) 
